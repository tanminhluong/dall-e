...
const Comments = ({
  ...
  return (
    <div className="relative border-t-2 border-gray-200 pt-4 px-10 mt-4 mb-4 bg-[#F8F8F8] border-b-2 lg:pb-[100px] pb-[100px]">
      ...
      <div className="absolute w-full bottom-0 left-0  pb-6 px-2 md:px-10 ">
        <form onSubmit={addComment} className="flex gap-4">
          ...
          />
          <button className="text-sm text-gray-700 " onClick={addComment}>
